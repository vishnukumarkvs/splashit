  ...
  return (
    <div>
      ...
      <div className="flex justify-evenly p-5 mt-10 items-center">
        <p className="font-bree font-bold text-5xl">
          {" "}
          Featured <br /> Collections{" "}
        </p>
        <p>
          Our company was built by trust <br /> and reputation. we know how to
          <br /> make our customers love us
        </p>
      ...
      <div className="">
        <div className="grid grid-cols-4 gap-x-0  justify-items-center p-10 mx-10">
            <ImageGridComponent/>
            <ImageGridComponent/>
            <ImageGridComponent/>
            <ImageGridComponent/>
